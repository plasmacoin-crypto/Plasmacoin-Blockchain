/****************************************************************************
** Meta object code from reading C++ file 'mining-status.h'
**
...
#include <memory>
#include "../plasmacoin-client/mining-status.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'mining-status.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 7, 14), // "FinishedMining"
QT_MOC_LITERAL(2, 22, 0) // ""

    },
    "Status\0FinishedMining\0"
};
...
void Status::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->FinishedMining(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Status::FinishedMining)) {
                *result = 0;
                return;
            }
        }
